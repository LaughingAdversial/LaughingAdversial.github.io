...
./setup_for_v2/ImageDownload/imagesMinifabricCarbon.sh

ARCH=$(shell go env GOARCH)

if [ "$ARCH" == "arm64" ]; then
    #download images refering to amd or arm
    ./setup_for_v2/ImageDownload/imagesMinifabricARM.sh
    ./setup_for_v2/ImageDownload/overwriteImagesInSubmodule.py
else
